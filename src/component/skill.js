  ...
  return (
    <div id={skill} className="skillContainer">
      <div className="flexSkill">
        <span className="flexSkill_span none">
          <hr />{" "}
        </span>
        <p className="flexSkill_para">MY SKILLS </p>
        <span className="flexSkill_span ">
          <hr />
        </span>
      </div>
      ...
      <div className="iconsContainer">
        <p className="para">
          ...
          <span className="para_span" style={{ width: "85%" }}>
            {" "}
          </span>
        </p>
        ...
        <p className="para">
          ...
          <span className="para_span" style={{ width: "75%" }}>
            {" "}
          </span>
        </p>
        ...
        <p className="para">
          ...
          <span className="para_span" style={{ width: "80%" }}>
            {" "}
          </span>
        </p>
        ...
        <p className="para">
          ...
          <span className="para_span" style={{ width: "70%" }}>
            {" "}
          </span>
        </p>
        ...
        <p className="para">
          ...
          <span className="para_span" style={{ width: "55%" }}>
            {" "}
          </span>
        </p>
      </div>
      ...
      <div className="flexLove">
        <span className="flexLove_span none">
          <hr />{" "}
        </span>
        <p className="flexLove_para">LOVE TO DO </p>
        <span className="flexLove_span">
          <hr />{" "}
        </span>
      </div>
      ...
      <div className="hobbyContainer">
        <p>
          <FaCode className="hobbyContainer_icons" />
          <br />
          Coding{" "}
        </p>

        <p>
          <IoGameControllerOutline className="hobbyContainer_icons" />
          <br />
          Gaming{" "}
        </p>
      </div>
