...
import { FaGithub,FaWhatsapp , FaLinkedinIn, FaDotCircle} from "react-icons/fa";
...
const {home,about} = props
	return(
		...
		<li>Web Developer </li>
		<li><FaDotCircle className="periodIcons" /> </li> 
		<li>React Expert </li>
		<li><FaDotCircle className="periodIcons" /> </li> 
		...
		<span className="gridFollow_span none" > <hr/> </span>
		<p className="gridFollow_para"> FOLLOW ME </p>
		 <span className="gridFollow_span"> <hr/> </span>
		</div>

		<div className="socials">
		<a href="https://github.com/Solom0m"> <FaGithub/> </a>
		<a href="https://x.com/therealnnamani?t=7GmwKXQ6yeHkb-S5OHQopg&s=09"> <BsTwitterX/> </a>
