...
//PROJECT FOLDER OR COMPONENT
const Project = (props) => {
  const { project } = props;
  return (
    <div id={project} className="projectContainer">
      <div className="portfolioContainer">
        <span className="portfolioContainer_span none">
          {" "}
          <hr />{" "}
        </span>
        <p className="portfolioContainer_para"> PORTFOLIO </p>
        <span className="portfolioContainer_span">
          {" "}
          <hr />{" "}
        </span>
      </div>
      ...
      <div className="projectFolder">
        <div className="projectFolder_design">
          ...
          <p className="text">
            A nice portfolio equipped with fantastic functionality and great UI.
          </p>
          <br />
          <span className="text" style={{ fontSize: "10px", color: "grey" }}>
            HTML{" "}
          </span>
          <span className="text" style={{ fontSize: "10px", color: "grey" }}>
            {" "}
